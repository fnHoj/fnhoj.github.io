...
const voltage_input = document.getElementById("voltage") as HTMLInputElement;
const temperature_input = document.getElementById("temperature") as HTMLInputElement;
